 ...
 * <p>
 * Description：使用了jedis客户端，对redis进行了封装，包括：
...
public class JedisUtil {
     ...
     * redis 配置
     */
    private static class JRedisPoolConfig {
        public static final String REDIS_IP = "47.95.208.138";
        public static final int REDIS_PORT = 6379;
        public static final String REDIS_PASSWORD = "123456a!";
    }
